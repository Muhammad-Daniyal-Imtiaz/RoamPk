    ...
    <main className="flex min-h-screen items-center justify-center px-4 pt-24">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 grid h-16 w-16 place-items-center rounded-[1.5rem] bg-[#006600] text-2xl font-black text-white shadow-lg shadow-green-900/20">
            PK
          </div>
          <h1 className="text-3xl font-black text-white">Join RoamPK</h1>
          <p className="mt-2 text-gray-400">Start your Pakistan travel journey</p>
        </div>
        ...
        <Card>
          <CardContent className="space-y-6">
            ...
            <p className="text-center text-sm text-gray-500">
              ...
              <Link href="/sign-in" className="font-semibold text-[#006600] hover:underline">
                Sign in
              </Link>
            </p>
          </CardContent>
